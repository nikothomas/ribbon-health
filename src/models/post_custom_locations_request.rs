...
/// PostCustomLocationsRequest : A JSON object describing the location you want to create.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PostCustomLocationsRequest {
...
impl PostCustomLocationsRequest {
    /// A JSON object describing the location you want to create.
    pub fn new() -> PostCustomLocationsRequest {
