...
pub struct GetCustomProviderTypes200Response {
    /// The total number of results matched, across all pages.
    #[serde(rename = "count")]
    pub count: i32,
    /// 
    #[serde(rename = "results", skip_serializing_if = "Option::is_none")]
    pub results: Option<Vec<models::GetCustomProviderTypes200ResponseResultsInner>>,
}

impl GetCustomProviderTypes200Response {
    pub fn new(count: i32) -> GetCustomProviderTypes200Response {
