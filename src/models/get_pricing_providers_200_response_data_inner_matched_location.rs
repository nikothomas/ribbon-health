...
/// GetPricingProviders200ResponseDataInnerMatchedLocation : All of the metadata on the matched location plus a `costs` key.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetPricingProviders200ResponseDataInnerMatchedLocation {
    #[serde(rename = "costs", skip_serializing_if = "Option::is_none")]
    pub costs: Option<models::GetPricingProviders200ResponseDataInnerMatchedLocationCosts>,
    ...
    pub tins: Option<String>,
}

impl GetPricingProviders200ResponseDataInnerMatchedLocation {
    /// All of the metadata on the matched location plus a `costs` key.
    pub fn new() -> GetPricingProviders200ResponseDataInnerMatchedLocation {
