...
/// EditCustomLocationFilterRequest : A JSON object mapping the name of the field to update to its new value.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EditCustomLocationFilterRequest {
...
impl EditCustomLocationFilterRequest {
    /// A JSON object mapping the name of the field to update to its new value.
    pub fn new(parameter: String, field: String, value_type: ValueType, filter_type: FilterType) -> EditCustomLocationFilterRequest {
