...
pub struct GetConditions200Response {
    ...
    pub results: Vec<models::GetCustomProviders200ResponseParametersClinicalAreaIdsConditionsInner>,
}

impl GetConditions200Response {
    pub fn new(count: i32, next: Option<String>, previous: Option<String>, parameters: Option<serde_json::Value>, results: Vec<models::GetCustomProviders200ResponseParametersClinicalAreaIdsConditionsInner>) -> GetConditions200Response {
