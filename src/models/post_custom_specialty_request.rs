...
/// PostCustomSpecialtyRequest : A JSON object mapping the name of the field to update to its new value
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PostCustomSpecialtyRequest {
