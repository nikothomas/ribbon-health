...
pub struct GetProcedures200Response {
    ...
    pub results: Vec<models::GetProcedures200ResponseResultsInner>,
}

impl GetProcedures200Response {
    pub fn new(count: i32, next: Option<String>, previous: Option<String>, results: Vec<models::GetProcedures200ResponseResultsInner>) -> GetProcedures200Response {
