...
pub struct GetTreatments200Response {
    ...
    pub results: Vec<models::GetCustomProviders200ResponseParametersClinicalAreaIdsTreatmentsInner>,
}

impl GetTreatments200Response {
    pub fn new(count: i32, next: Option<String>, previous: Option<String>, parameters: Option<serde_json::Value>, results: Vec<models::GetCustomProviders200ResponseParametersClinicalAreaIdsTreatmentsInner>) -> GetTreatments200Response {
