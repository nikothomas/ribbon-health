...
/// CreateCustomProviderFilterRequest : The new filter to create
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CreateCustomProviderFilterRequest {
...
impl CreateCustomProviderFilterRequest {
    /// The new filter to create
    pub fn new(parameter: String, field: String, value_type: ValueType, filter_type: FilterType) -> CreateCustomProviderFilterRequest {
